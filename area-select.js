    ...
    function handleRecord() {
        ...
        function onRecordingResult(event) {
            ...
            if (event.data?.type === '__dreamlab_recording_done__') {
                ...
                // Show error toast via background
                chrome.runtime.sendMessage({
        ...
        // Ask background to inject the recorder into the MAIN world.
        // Using chrome.scripting.executeScript with world:'MAIN' bypasses page CSP,
        // which would block inline <script> tag injection on many sites.
        chrome.runtime.sendMessage({
